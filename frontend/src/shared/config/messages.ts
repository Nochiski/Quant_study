const ko = {
  ...
  "ide.history": "되돌리기·다시 실행",
  "ide.undo": "되돌리기",
  "ide.redo": "다시 실행",
  "ide.undo.empty": "되돌릴 편집 없음",
  "ide.redo.empty": "다시 실행할 편집 없음",
  "ide.history.empty": "되돌리거나 다시 실행할 편집 없음",
  "command.open": "명령",
...
export const messages = {
  ...
  en: {
    ...
    "ide.history.empty": "Nothing to undo or redo",
