...
active_prs: [P5-01]
parallel_window: []
last_updated: 2026-09-05T12:43:35+09:00
planned_prs: 50
merged_prs: 41
approved_prs: 41
progress_percent: 82
...
| Approved | `41 / 50` |
| Aggregated at | `2026-09-05 12:43 KST` |
<!-- PLAN:SUMMARY:END -->
...
| 항목 | 값 |
|---|---|
| PR | `P5-01` Correctness pipeline을 조회하는 scoped trace API IN_REVIEW · same reviewer third pass · [#65](https://github.com/Nochiski/Quant_study/pull/65) |
...
| Head SHA | `bdafc33` (second review-fix freeze; initial implementation `752f66b`) |
...
| 완료 | PR | 결과물 | Dependency | 상태 | Review |
|---|---|---|---|---|---|
| [ ] | `P5-01` | Correctness pipeline을 조회하는 scoped trace API | P1.5-04, P1-03 | `IN_REVIEW` | [#65](https://github.com/Nochiski/Quant_study/pull/65) · second review fix `bdafc33` · `review_p5_01` third pass 요청 |
...
|---|---|---|---|---|---|---|
| P5-01 | second-review regression 포함 strategy numeric/factor overflow/portfolio tape/raw port/trace HTTP·preflight/truthful pipeline 216 passed | backend pytest 1,003·Ruff·Pyright; frontend typecheck·lint·Vitest 368·build | OpenAPI/SDK 2회 17-file SHA-256 deterministic; legacy tape JSON byte hash parity | 모든 StrategySpec float leaf finite preflight, factor/portfolio overflow 동일 coded 422, frame numeric invariant, rebalance/materialization/stream hash cancellation, legacy preview/backtest port와 trace capability diagnostic 검증 | [#65](https://github.com/Nochiski/Quant_study/pull/65) second review fix `bdafc33`; same reviewer third pass·latest CI 대기 | 2026-09-05 |
