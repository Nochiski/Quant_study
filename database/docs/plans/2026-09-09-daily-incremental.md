...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-09 18:10 — P2 키움 제외 완료, P3 크론 가동(브랜치 `feat/daily-p0`) |
...
| P2 갭 메우기 | **키움 제외 완료**(09-09) — 2.1 KRX·2.3 KIS·2.4 DART(9/10 통과, 08-27 + 08-20~25 후속 재실행 중)·2.5 유니버스. **2.2 키움은 토요일 09-12 11:00 일회성 크론** |
