...
active_prs: [P5-01]
parallel_window: []
last_updated: 2026-09-05T13:57:30+09:00
planned_prs: 50
merged_prs: 41
approved_prs: 41
progress_percent: 82
...
| Approved | `41 / 50` |
| Aggregated at | `2026-09-05 13:57 KST` |
<!-- PLAN:SUMMARY:END -->
...
| 항목 | 값 |
|---|---|
| PR | `P5-01` Correctness pipeline을 조회하는 scoped trace API IN_REVIEW · same reviewer fifth pass · [#65](https://github.com/Nochiski/Quant_study/pull/65) |
...
| 완료 | PR | 결과물 | Dependency | 상태 | Review |
|---|---|---|---|---|---|
| [ ] | `P5-01` | Correctness pipeline을 조회하는 scoped trace API | P1.5-04, P1-03 | `IN_REVIEW` | [#65](https://github.com/Nochiski/Quant_study/pull/65) · fourth review fix `29e15e0` · `review_p5_01` fifth pass 요청 |
...
|---|---|---|---|---|---|---|
| P5-01 | fourth-fix focused 251 passed; architecture 7 passed | backend pytest 1,027·Ruff `src tests`·Pyright; frontend typecheck·lint·Vitest 369·build | API wire 변경 없음; 기존 OpenAPI/SDK 17-file deterministic·schema parity 증거 유지 | constructor/consumer raw numeric은 첫 check 뒤 중단, scope observation과 factor output은 첫 원소만 소비; FactorGraph/TargetTape·projection 후속 단계 미진입 검증 | [#65](https://github.com/Nochiski/Quant_study/pull/65) fourth review fix `29e15e0`; same reviewer fifth pass 요청 | 2026-09-05 |
