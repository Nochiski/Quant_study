...
-- UNLISTED_KINDS **대응표**(오타·동의어·표기 변형 → 폐쇄 어휘, 명시 문자열만)와 같은 리터럴이어야
-- 한다(tests 가 대조). 공백·개행 정규화는 stage(PR #70) 몫이고 아래 trim 은 옛 절단본 방어용.
--
...
capital AS (
    SELECT rcept_no, corp_code, 'capital' AS source,
           ...
           -- 종류 대응표 = rules_s05.COMMON_KINDS · PREFERRED_KINDS · UNLISTED_KINDS (순서까지 같다).
           -- trim 은 옛 절단본 방어용 — 공백·개행·NFKC 정규화는 stage(PR #70) 가 했다.
           CASE WHEN trim(isu_dcrs_stock_knd) IN ('보통주', '보통주식', '기명식보통주', '기명식 보통주',
                '기명식보통주식', '기명식 보통주식', '보 통 주', '보통', '의결권이 있는 보통주',
                '의결권 있는 보통주', '의결권있는주식(보통주)', '보퉁주', '보통부', '부통주', '보톧주',
                '보통중', '보통즈', '보통투', '보동주', '보통수', '보총주', '보통주시', '통주',
                '보통주(*1)', '보통주(*2)', '보통주(*3)', '보통주(*4)', '보통주(*5)', '보통주*1)',
                '보통주*3)', '보통주(주1)', '보통주(주3)', '보통주 (주1)', '보통주 (주2)', '보통주주1)',
                '보통주주2)', '보통주주3)', '보통주 발행', '보통주 무상증자', '보통주(차감)', '보통주(-)',
                '보통주(일반공모)', '보통주(KDR)') THEN 'common'
                WHEN trim(isu_dcrs_stock_knd) IN ('우선주', '우선주식', '기명식우선주', '기명식 우선주',
                '기명식 우선주식', '우 선 주', '우선', '우선주(종류주)', '종류주식(우선주)',
                '의결권이 없는 우선주', '기타주식', '1우선주', '2우선주', '3우선주', '제1우선주',
                '제3우선주', '제1종 우선주', '제2종 우선주', '제1종우선주', '제2종우선주', '제2회우선주식',
                '제3회우선주식', '우선주A', '우선주B', '우선주C', '3우B', '종류주식(1우선주)',
                '종류주식(2우선주)', '우선주(*)', '우선주*1)', '우선주주3)', '우선주주4)', '우선주주5)',
                '우선주(감소)') THEN 'preferred'
                WHEN trim(isu_dcrs_stock_knd) IN ('상환전환우선주', '상환전환 우선주', '상환 전환 우선주',
                '상환전환우선주식', '(상환전환우선주)', '상환전환우선주(*1)', '상환전환우선주(제1종)',
                '상환전환우선주(제2종)', '제1종 상환전환우선주', '제2종 상환전환우선주',
                '제1종 상환전환우선주 (주1)', '제1종 상환전환우선주 (주2)', '기명식 상환전환우선주',
                '기명식 상환전환우선주(제1종)', '의결권 있는 상환전환우선주', '의결권 있는상환전환우선주',
                '의결권 없는 상환전환우선주',
                ...
                '전환상환우선주 및상환우선주', 'RCPS', 'RCPS1', 'RCPS2', 'RCPS3', 'RCPS4', 'RCPS5',
                'RCPS6', 'RCPS7', 'RCPS8', 'RCPS9', 'RCPS 1종', 'RCPS 2종', 'RCPS 3종', 'RCPS 4종',
                'RCPS 5종', 'RCPS 6종', 'RCPS(제1종)', 'RCPS(제2종)', 'RCPS (제1종 및 제2종',
                '우선주(RCPS)', '전환상환우선주', '전환상환 우선주', '전환상환우선주식', '전환상환우선주(-)',
                '전환상환3우선주', '기명식전환상환2종우선주', '전환우선주', '전환 우선주', '기명식 전환우선주',
                '전환우선주(감소)', '전환우선주(*1)', '전환우선주(*)',
                ...
                '제구전환우선주', 'CPS', 'CPS 7종', '상환우선주', '전환주') THEN 'unlisted'
