const ko = {
  ...
  "backtest.runner.kicker": "PERSISTENT RUST ENGINE",
  "backtest.runner.title": "전략 실행과 전문 성과 분석",
  "backtest.runner.description":
    "현재 StrategySpec을 TargetTape로 컴파일한 뒤 엔진에서 실행합니다. Python core는 패리티 디버깅용입니다.",
  "backtest.runner.registry": "MetricRegistry v1 · 21 metrics",
  "backtest.runner.core": "실행 core",
  "backtest.runner.core.rust": "Persistent Rust",
  "backtest.runner.core.python": "Python reference",
  "backtest.runner.initialCash": "초기 자본 (KRW)",
  "backtest.runner.benchmark": "벤치마크 종목 ID",
  "backtest.runner.oosStart": "OOS 시작일 (선택)",
  "backtest.runner.run": "백테스트 실행",
  "backtest.runner.rerun": "새 백테스트 실행",
  "backtest.runner.cancel": "실행 취소",
  "backtest.runner.error":
    "실행 요청 또는 결과 조회에 실패했습니다. 입력 조건과 API 상태를 확인하세요.",
  "backtest.runner.resultLoading": "결과 artifact를 불러오는 중입니다.",
...
export const messages = {
  ...
  en: {
    ...
    "backtest.runner.kicker": "PERSISTENT RUST ENGINE",
    "backtest.runner.title": "Strategy execution and professional analytics",
    "backtest.runner.description":
      "Compile the current StrategySpec into a TargetTape and execute it in the engine. The Python core is for parity debugging.",
    "backtest.runner.registry": "MetricRegistry v1 · 21 metrics",
    "backtest.runner.core": "Execution core",
    "backtest.runner.core.rust": "Persistent Rust",
    "backtest.runner.core.python": "Python reference",
    "backtest.runner.initialCash": "Initial capital (KRW)",
    "backtest.runner.benchmark": "Benchmark security ID",
    "backtest.runner.oosStart": "OOS start date (optional)",
    "backtest.runner.run": "Run backtest",
    "backtest.runner.rerun": "Run another backtest",
    "backtest.runner.cancel": "Cancel run",
    "backtest.runner.error":
      "The run request or result lookup failed. Check the inputs and API status.",
    "backtest.runner.resultLoading": "Loading the result artifact.",
