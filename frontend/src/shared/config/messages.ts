const ko = {
  ...
  "history.backtests.description":
    "이 서버 프로세스가 보유한 실행 상태와 정확한 전략 provenance를 확인합니다.",
  "history.backtests.filter": "전략 ID",
  "history.backtests.filterPlaceholder": "전체 전략 또는 strategy_id",
  "history.backtests.applyFilter": "필터 적용",
  "history.backtests.error": "백테스트 이력을 불러올 수 없습니다.",
  "history.backtests.emptyTitle": "백테스트 실행이 없습니다",
  "history.backtests.empty": "전략 편집기에서 백테스트를 실행해 보세요.",
  "history.backtests.caption": "백테스트 실행 목록",
  "history.backtests.status": "상태",
  "history.backtests.strategy": "전략 provenance",
  "history.backtests.created": "시작 시각",
  "history.backtests.inline": "저장 전 inline draft",
  "history.backtests.open": "결과 열기",
...
export const messages = {
  ...
  en: {
    ...
    "history.backtests.description":
      "Inspect run state and exact strategy provenance retained by this server process.",
    "history.backtests.filter": "Strategy ID",
    "history.backtests.filterPlaceholder": "All strategies or strategy_id",
    "history.backtests.applyFilter": "Apply filter",
    "history.backtests.error": "Backtest history could not be loaded.",
    "history.backtests.emptyTitle": "No backtest runs",
    "history.backtests.empty": "Start a backtest from the strategy editor.",
    "history.backtests.caption": "Backtest runs",
    "history.backtests.status": "Status",
    "history.backtests.strategy": "Strategy provenance",
    "history.backtests.created": "Started at",
    "history.backtests.inline": "Unsaved inline draft",
    "history.backtests.open": "Open result",
    "problems.compileUnavailable":
