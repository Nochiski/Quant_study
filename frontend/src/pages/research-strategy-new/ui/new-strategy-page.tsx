...
/**
 * New-strategy entry: the IDE frame with placeholder content. The source editor (P3) and the
  ...
  <StrategyIde
    ...
    editor={
      <div className="ide__placeholder">
        ...
        <Link to="/legacy/builder" search={{}} className="ui-button ui-button--secondary">
          {t("nav.legacyBuilder")}
        </Link>
      </div>
    }
