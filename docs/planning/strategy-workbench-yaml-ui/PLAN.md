...
active_prs: [P5-02]
parallel_window: []
last_updated: 2026-09-05T14:57:33+09:00
planned_prs: 50
merged_prs: 42
approved_prs: 42
progress_percent: 84
...
| Approved | `42 / 50` |
| Aggregated at | `2026-09-05 14:57 KST` |
<!-- PLAN:SUMMARY:END -->
...
| P5 | Truthful Trace UI | 3 | 1 | `IN_REVIEW` |
...
| [ ] | `P5-02` | Date/security/node 선택 Debugger shell | P3-05, P5-01, P2-03 | `IN_REVIEW` | [#67](https://github.com/Nochiski/Quant_study/pull/67) · `review_p5_02` 배정 대기 |
...
|---|---|---|---|---|---|---|
| P5-02 | trace request/response·TargetTape projection·debugger UI·composition·route integration 40 passed | frontend typecheck·lint·Vitest 388·build; backend pytest 1,027·Ruff·Pyright | OpenAPI/SDK 재생성 deterministic·diff clean | date/security/factor/node 선택, URL 복원, saved/inline source, loading·cancel·empty·error·discard·blocked, exact 4-fingerprint provenance와 zero/null 표시를 route/UI 회귀로 검증 | [#67](https://github.com/Nochiski/Quant_study/pull/67) CI 진행 중 | 2026-09-05 |
