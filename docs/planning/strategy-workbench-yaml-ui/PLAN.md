...
last_updated: 2026-09-05T04:14:17+09:00
planned_prs: 49
merged_prs: 34
approved_prs: 34
progress_percent: 69
...
| Approved | `34 / 49` |
| Aggregated at | `2026-09-05 04:14 KST` |
<!-- PLAN:SUMMARY:END -->
...
| Head SHA | `f970dc6` (P1 3건 수정 code freeze) |
| Diff stat | handwritten 14 files, +970/-25; generated OpenAPI/SDK 제외. P4-09 UI는 분리했고 reviewer가 요구한 backend metadata/provenance contract는 안전한 query의 선행조건이라 같은 PR에 유지 |
| Focused tests | backend factor HTTP 5·truthful/factor 21 passed; frontend execution orchestration 7 passed |
| Full gate | backend 897·Ruff·Pyright; frontend 277·typecheck·lint·build; OpenAPI/SDK deterministic·clean |
...
| [ ] | `P4-04` | Backend Execution Plan query·version gate·source mapping model | P3-05, P4-02 | `CHANGES_REQUESTED` | [#57](https://github.com/Nochiski/Quant_study/pull/57) · `review_p4_04` 잔여 P1 1건 수정 중 |
...
|---|---|---|---|---|---|---|
| P4-04 | backend factor HTTP 5·truthful/factor 21, frontend orchestration 7 passed | backend 897·Ruff·Pyright; frontend 277·typecheck·lint·build | OpenAPI/SDK 재생성 deterministic·clean | UI projection은 P4-09로 분리; backend group metadata plan/숫자 group 거부·plan-null provenance·compiled/runtime schema 0-request·dataset/registry response drift·abort·pointer 검증 | [#57](https://github.com/Nochiski/Quant_study/pull/57) 1차 CI 4 pass, 수정 HEAD 재실행 대기 | 2026-09-05 |
