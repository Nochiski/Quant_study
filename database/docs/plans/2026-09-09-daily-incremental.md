...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-10 15:00 — P3 관찰 1/5 통과 + 첫 적재분 검수 완료(`reviews/2026-09-10-intake-audit-summary.md`) + **핫픽스 3건 배포**(`52d0f48`: WISE 커버 판정 3개년·키움 유예 3종·DART 직전 분기 30일 재스윕+삭제 허용, 서버 반영·스모크 통과). 09-11 실행에서 확인할 것: WISE 무커버 4콜 항등식, 036010·190510·342870 커버 복귀. PR #96 |
