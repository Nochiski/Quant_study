...
| 항목 | 값 |
|---|---|
| 최종 갱신 | 2026-09-10 17:00 — P3 관찰 1/5 통과 + 첫 적재분 검수 완료(`reviews/2026-09-10-intake-audit-summary.md`) + 핫픽스 3건 배포(`52d0f48`) + **사용자 결정 3건 반영**(DECISIONS_PENDING 결정 6: ① 키움 머지 신규 행만 적재 — 구현·배포 ② KIS 재수집 판본은 최초 관측판 — P5 항목 ③ G3 #3·#4 개정). 09-11 실행에서 확인할 것: WISE 무커버 4콜 항등식, 036010·190510·342870 커버 복귀, 키움 merge `changed=0`. PR #96 |
