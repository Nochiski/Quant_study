...
active_prs: [P5-03]
parallel_window: []
last_updated: 2026-09-05T17:37:43+09:00
planned_prs: 50
merged_prs: 43
approved_prs: 43
progress_percent: 86
...
| Approved | `43 / 50` |
| Aggregated at | `2026-09-05 17:37 KST` |
<!-- PLAN:SUMMARY:END -->
...
| P5 | Truthful Trace UI | 3 | 2 | `IN_REVIEW` |
...
| 항목 | 값 |
|---|---|
| PR | `P5-03` Raw→Target full linked trace UI IN_REVIEW |
...
| [ ] | `P5-03` | Raw→Target trace, risk before/after, order delta estimate | P4-01, P4-07, P5-02 | `IN_REVIEW` | [#68](https://github.com/Nochiski/Quant_study/pull/68) · `review_p5_03` P1 2건 수정 완료·재검토 중 · fix `72bff34` |
