...
last_updated: 2026-09-05T04:48:12+09:00
planned_prs: 49
merged_prs: 35
approved_prs: 35
progress_percent: 71
...
| P4 | Outline, Contract, Projections | 9 | 4 | `SELF_CHECK` |
...
| 항목 | 값 |
|---|---|
| PR | `P4-09` Execution Plan projection SELF_CHECK |
...
| Head SHA | `160fad4` (code freeze) |
| Diff stat | 7 files, +806/-0. 상태·키보드·source navigation 검증까지 한 projection 단위이며 component/test/page wiring을 더 분리하면 독립 acceptance가 없어 600줄 예외를 기록 |
| Focused tests | execution query·panel projection 21 passed |
| Full gate | frontend 291·typecheck·lint·build; real backend PIT E2E 포함 |
...
| [ ] | `P4-09` | Execution Plan 표시와 YAML/graph selection 연동 | P4-04, P4-01 | `SELF_CHECK` | `review_p4_09` 예정 |
...
|---|---|---|---|---|---|---|
| P4-09 | execution query·panel projection 21 passed | frontend typecheck·lint·vitest 291·build; real backend PIT E2E 포함 | generated API 변경 없음 | backend step 순서·input/output type/unit·history·registry/dataset·fingerprint 표시, 모든 blocked/loading/error/incompatible/invalid 상태, factor/node/input pointer와 route selection 검증 | PR/CI 대기 | 2026-09-05 |
