...
#     때까지 60초 간격으로 본다. 한도는 19:45 KST(QL_EVENING_BUILD_DEADLINE 로 조정 — 키움이 19:05 부터 받는다). DART 는
...
DEADLINE_HHMM="${QL_EVENING_BUILD_DEADLINE:-19:45}"   # 키움 19:05 수집(≈14분) 뒤 인계 파일 ≈19:20
