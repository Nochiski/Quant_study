...
| 항목 | 값 |
|---|---|
| PR | `P1-02`→…→`P1-09` stack (main 트리 + worktrees `Quant_study-p1-05`, `Quant_study-p1-06`; P1-02 4차 확인 대기, P1-03 APPROVED, P1-05~09 IN_REVIEW) + `P2-01` (worktree `Quant_study-p2-01`, IN_REVIEW) |
