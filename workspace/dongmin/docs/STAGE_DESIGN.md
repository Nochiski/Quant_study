...
- **G7 격리 셀**: capital 15 · delisted_master 5 · tsstk_dp 1 — 전부 임계 내, 행 reject 0. 표본 검수: capital 15 = 오타 7(2120·2121·2202·2923) + **정상 현물출자일 8(1952~54)** → 내용일 하한 1956 → 1900 으로 정정, capital 재빌드(격리 7).
